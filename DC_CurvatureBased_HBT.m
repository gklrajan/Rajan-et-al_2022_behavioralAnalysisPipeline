%% 
%short-term kinematics of DC (might be referred with its ealier name DT in
% some places)
...
%% velo plot - for representative slow and fast streached of swims
...
forVeloFilt_intrp_filtfilt        = filtfilt(, 1, forVeloFilt_intrp_a);
